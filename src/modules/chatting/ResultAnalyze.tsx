...
import { AudioItem, CategoriesWellBeing } from './components/CategoriesWellBeing'
...
export const ResultAnalyze = ({
  ...
  return (
    <div className='flex flex-col py-4 gap-4'>
      ...
      {musicData && podcastData && yogaData && storyData && (
        <CategoriesWellBeing
          musicData={musicData}
      ...
      <SuggestedDocuments documents={documents} />
    </div>
  )
}
