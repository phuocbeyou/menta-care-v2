      ...
      <Grid2 size={{ xs: 12, md: 6, lg: 5 }} className='md:w-1/2  h-[350px] md:h-[400px]'>
        <Box className='flex flex-col justify-between h-full'>
          <SlideUp delay={0.1} className='relative'>
            <div className='text-secondary font-semibold text-[3rem] md:text-[4.1rem] lg:text-[4.5rem] z-10'>
              WELL-BEING
            </div>
            <Box
          ...
          <SlideUp delay={0.2} className='mt-1'>
            <div className='font-semibold text-3xl leading-5 md:text-4xl md:leading-8'>
              GÓC CÂN BẰNG
              <br />
              THÂN TÂM TRÍ
            </div>
